# Employee Management System Using Python - wazahat
...
# making Connection
con = pymysql.connect(host="localhost", user="root", password="Huzaifa@123", database="employee")
